...
const statsInsight=buildAutoInsight(DATA,{accuracyRows:norm,anomalyRows:buildAnomalyReport()});
...
${renderInsightCard(statsInsight)}`;
...
function renderFinanceStatistics(){
  ...
  ${renderInsightCard(buildAutoInsight(DATA,{movementRows:stats.filtered,anomalyRows:buildAnomalyReport()}))}
