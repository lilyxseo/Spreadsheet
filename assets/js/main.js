...
const LARGE_CACHE_KEYS=new Set(Object.values(MODULE_CACHE_KEYS));
...
["barangMasukCache","barangKeluarCache","inventoryCache","movementCache"].forEach(key=>{if(localStorage.getItem(key)!==null)localStorage.removeItem(key);});
