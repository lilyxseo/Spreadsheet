...
const currentHasIdentity=current&&String(current.sku||'').trim()&&String(current.qty||'').trim();
const startsNew=(currentHasIdentity&&hasSku&&hasQty)||(!currentHasData&&(hasRowNumber||hasSku||hasQty));
