...
const filtered=filteredByType.filter(r=>{const d=parseDateSafe(r.tanggal);if(!d||d<cutoff)return false;const to=getToValue(r);if(!to)return false;return true;});
