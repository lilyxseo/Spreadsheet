...
const BALIKAN_STATE={sheets:[],highlightRowNumber:null,sortBy:"default",autoCheckOnScan:true};
window.BALIKAN_ROWS=[];
...
function resetBalikanFilter(){window.balikanSearchKeyword='';if(balikanSearchInput)balikanSearchInput.value='';if(balikanSortSelect)balikanSortSelect.value='default';BALIKAN_STATE.sortBy='default';BALIKAN_STATE.highlightRowNumber=null;const st=ensureBalikanFilterState();st.columnFilters={};st.openFilterCol='';renderBalikanTable(false);}
