...
function getLocationTypeByDigit(lokasi){const digits=String(lokasi||'').replace(/\D/g,'');if(digits.includes('5'))return 'bulky';if(digits.includes('8'))return 'retail';return 'other';}
