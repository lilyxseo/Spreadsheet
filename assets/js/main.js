...
const toOptions=(data.toOptions||[]);
const toFiltered=toOptions.filter(v=>clean(v).includes(clean(ABC_STATE.toSearch||"")));
...
if(document.getElementById("abcToSelectAll"))document.getElementById("abcToSelectAll").onclick=()=>{ABC_STATE.selectedTo=[...toOptions];renderAbcAnalisisPage(true);};
