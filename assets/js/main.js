...
function renderRejectInputIn(){return `<div class="card reject-form-card"><form id="rejectInForm" class="sheet-input-form"><div class="sheet-grid"><label>Tanggal<input type="date" name="tanggal" value="${todayIso()}"></label><label>Lokasi *<input name="lokasi" required></label><label>SKU *<input name="sku" required></label><label>Nama Barang<input name="namaBarang"></label><label>Qty *<input type="number" name="qty" min="1" step="1" required></label><label>Keterangan<textarea name="keterangan" rows="3"></textarea></label></div><button class="btn-primary" type="submit" ${BARANG_REJECT_STATE.submittingIn?'disabled':''}>${BARANG_REJECT_STATE.submittingIn?'Menyimpan...':'Simpan Barang Masuk Reject'}</button></form></div>`;}
function renderRejectInputOut(){return `<div class="card reject-form-card"><form id="rejectOutForm" class="sheet-input-form"><div class="sheet-grid"><label>Tanggal<input type="date" name="tanggal" value="${todayIso()}"></label><label>From *<input name="from" required></label><label>To<input name="to"></label><label>SKU *<input name="sku" required></label><label>Nama Barang<input name="namaBarang"></label><label>Qty *<input type="number" name="qty" min="1" step="1" required></label><label>PIC<input name="pic"></label><label>No iSeller<input name="noIseller"></label><label>Netsuite<input name="netsuite"></label><label>Keterangan<textarea name="keterangan" rows="3"></textarea></label><label>Lokasi Surat Jalan<input name="lokasiSuratJalan"></label></div><button class="btn-primary" type="submit" ${BARANG_REJECT_STATE.submittingOut?'disabled':''}>${BARANG_REJECT_STATE.submittingOut?'Menyimpan...':'Simpan Barang Keluar Reject'}</button></form></div>`;}
