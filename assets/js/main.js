...
function onSearchShortcut(e){const isCmdK=(e.ctrlKey||e.metaKey)&&String(e.key).toLowerCase()==="k";if(isCmdK){e.preventDefault();return openSearchModal();}if(e.key==="Escape"&&!searchModal?.classList.contains("hidden")){e.preventDefault();closeSearchModal();}}
