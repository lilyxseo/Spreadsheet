...
function getLocationTypeByDigit(lokasi){const digits=String(lokasi||'').replace(/\D/g,'');if(digits.length===5)return 'bulky';if(digits.length===8)return 'retail';return 'other';}
