...
function isRefillSourceLokasi(lokasi){return String(lokasi||"").includes("5");}
function getRefillSourceRows(){return (getMovementSourceRows()||[]).filter(r=>isRefillSourceLokasi(r.lokasi));}
