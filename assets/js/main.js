...
function renderMovementSession(){return `<div class='cc-section'><div class='mv-toolbar'><div class='search-with-scan'><input id='movementSearchInput' class='form-input search-input' placeholder='Cari SKU...' autocomplete='off' value='${esc(MOVEMENT_STATE.searchInput)}'><button id='movementScanBtn' class='scan-btn' title='Scan Barcode' aria-label='Scan Barcode' type='button'><i data-lucide='scan-line'></i></button></div></div></div><div class='cc-section'><div class='table-wrap cc-table-wrap cc-search-wrap'><table><thead><tr><th>Lokasi</th><th>SKU</th><th>Nama Barang</th><th>Qty</th><th>Aksi</th></tr></thead><tbody id='mvSearchResultsBody'></tbody></table></div></div><div class='cc-section'><h4>Movement Berjalan</h4><div class='table-wrap cc-table-wrap cc-session-wrap'><table><thead><tr><th>From</th><th>To</th><th>SKU</th><th>Nama Barang</th><th>Stok Lokasi Awal</th><th>Stok Aktual</th><th>Aksi</th></tr></thead><tbody id='mvSessionBody'></tbody></table></div></div>`;}
