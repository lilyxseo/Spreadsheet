...
function buildAnomalyReport(){
 ...
 ANOMALY_STATE.lastCheckedAt=new Date().toISOString();return rows.sort((a,b)=>({Critical:0,Warning:1,Info:2}[a.severity]-{Critical:0,Warning:1,Info:2}[b.severity]||Math.abs(b.selisih)-Math.abs(a.selisih));}
